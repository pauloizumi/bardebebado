...
<html>
  ...
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css" 
    ...
    <body bgcolor="f0f0f0">
        <form action="gravarBebida.jsp" method="POST">
            <table border="0" align="center">
                <thead>
                    <tr>
                        <td colspan="2" align="center"><h2>Confirmação do Bebida</h2></td>
                    </tr>
                </thead>
                <tbody>
                    <tr><td>Nome: </td><td>
                    ...
                    <tr><td>Preço: </td><td>
                            <input  type="text"  name="preco"  class="form-control"  value="<%=request.getParameter("preco") %>" />
                        </td>
                    </tr>
